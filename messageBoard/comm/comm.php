...
function get_Connect() {
    $connection = mysql_connect($GLOBALS["cfg"]["server"]["adds"],$GLOBALS["cfg"]["server"]["db_user"],$GLOBALS["cfg"]["server"]["db_psw"]);
    $db = @mysql_select_db($GLOBALS["cfg"]["server"]["db_name"],$connection);
